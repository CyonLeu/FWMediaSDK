...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Yong Liu/FWMediaSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Yong Liu' => 'liuyong@qupeiyin.com' }
  s.source           = { :git => 'https://github.com/Yong Liu/FWMediaSDK.git', :tag => s.version.to_s }
